...
namespace BusinessLayer.ValidationRules
{
    public class CategoryValidator : AbstractValidator<Category>
    {
        public CategoryValidator()
        {
            ...
            RuleFor(x => x.CategoryName).MinimumLength(3).WithMessage("En az 3 Karater olmalı!");
            RuleFor(x => x.CategoryName).MaximumLength(20).WithMessage("En fazla 20 karakter olabilir");
        }
    }
}
